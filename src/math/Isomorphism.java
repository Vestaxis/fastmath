 ...
 * 1] Two mathematical objects are isomorphic if an isomorphism exists between
 ...
 * @param <TO>
 */
public interface Isomorphism<FROM extends Space, TO extends Space> extends Morphism<FROM, TO>
{
  public Isomorphism<TO, FROM> getInverse();
}
