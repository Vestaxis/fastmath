...
public class RelativeLayout implements LayoutManager2, Serializable
{
   ...
   */
  private int
          getLocationY(Component component,
                       int height)
  {
   ...
   */
  private int
          getLocationX(Component component,
                       int width)
  {
    // Use the Container alignment policy
   ...
   */
  private int[]
          allocateRelativeSpace(Container parent,
                                int spaceAvailable,
                                float relativeTotal)
  {
    int spaceUsed = 0;
   ...
   */
  private void
          adjustLargest(int[] relativeSpace,
                        int spaceRemaining)
  {
    int largest = 0;
    int largestSpace = 0;
  ...
  private Dimension
          getDimension(Component component,
                       int type)
  {
    switch (type)
    {
