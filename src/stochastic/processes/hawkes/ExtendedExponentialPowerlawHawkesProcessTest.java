...
public class ExtendedExponentialPowerlawHawkesProcessTest extends TestCase
{
	public void testKernel()
	{
		...
		ExtendedExponentialPowerlawHawkesProcess exthp = new ExtendedExponentialPowerlawHawkesProcess( eplhp.getη(), eplhp.getε(), eplhp.αS(), eplhp.βS() );
...
//		double b = 0.01;
//		ExtendedExponentialPowerlawHawkesProcess process = new ExtendedExponentialPowerlawHawkesProcess( η, τ, ε, b );
//		process.T = new Vector( new double[] { 0.3, 0.5, 0.9, 1.2, 1.4, 2.0, 2.04, 2.06, 2.08 } );
