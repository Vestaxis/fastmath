...
public class DoubleColMatrix extends DoubleMatrix
{
   ...
   * {@link #incrementalCapacityExpasionFactor} ) * this{@link #getColCount()} and
  ...
  public int
         getOffsetRow(int intOffset)
  {
    return floorDiv(intOffset, getColIncrement());
  }

  public int
         getOffsetCol(int intOffset)
  {
  ...
  public DoubleColMatrix
         invert() throws NotInvertableException
  {
    ...
    LAPACK.instance.dgetrf_(rowCount, colCount, getPointer(), rowCount, pivotBuffer, outBuffer);
    ...
    LAPACK.instance.dgetri_(rowCount, getPointer(), rowCount, pivotBuffer, workspace.getPointer(), lwork, outBuffer);
    if (output.elementAt(0) > 0)
    {
      throw new NotInvertableException(output.elementAt(0));
    }
