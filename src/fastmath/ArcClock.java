...
/**
 * This class is a container class that maintains all of the parts that
 * comprised of a clock. It is also responsible for updating and drawing itself
 * at each animation frame cycle. The ArcClock contains zero to many ArcPiece
 * objects to be drawn. The clock will also display the time of day.
 *
 * User: cdea
 */
