...
<\body>
  ...
  <\note>
    ...
    arithmiticlibrary arblib<cite|Johansson2013arb> and compares the results
    against the tables published by Andrew Odlyzko<cite|zt>.\ 
  </note>
  ...
  <\equation>
    \<lambda\><rsub|N<rsub|f>><around*|(|t|)>=<frac|f<around*|(|t|)><wide|f|\<ddot\>><around*|(|t|)>|<wide|f|\<dot\>><around*|(|t|)>>
  </equation>
  ...
  <\proof>
    ...
    multiplier of its Newton map is <math|\<lambda\><rsub|N<rsub|Z>><around*|(|\<alpha\>|)>=><math|\<lambda\><rsub|f><around*|(|\<alpha\>|)>=<frac|Z<around*|(|\<alpha\>|)><wide|Z|\<ddot\>><around*|(|\<alpha\>|)>|<wide|Z|\<dot\>><around*|(|\<alpha\>|)>>=0
  ...
  <\lemma>
    The Newton map <math|N<rsub|2g*<around*|(|t|)>-t>> applied to an
    iteration function <math|g<around*|(|t|)>=t-f<around*|(|t|)>> has
    fixed-points <math|g<around*|(|t|)>=t> at the zeros of
    <math|f<around*|(|t|)>=0> then it transforms
  </lemma>
  ...
  <\bibliography|bib|tm-plain|references.bib>
    <\bib-list|7>
      ...
      <bibitem*|2><label|bib-HardyZ>A.<nbsp>Ivi¢.<newblock>
      ...
      <bibitem*|3><label|bib-Johansson2013arb>F.<nbsp>Johansson.<newblock>
      Arb: a C library for ball arithmetic.<newblock>
      <with|font-shape|italic|ACM Communications in Computer Algebra>,
      47(4):166\U169, 2013.<newblock>

      <bibitem*|4><label|bib-milnor2006dynamics>John<nbsp>Willard
      ...
      <slink|http://www.dtc.umn.edu/~odlyZko/zeta_tables/>.<newblock>

      <bibitem*|6><label|bib-ramachandra1995lectures>K Ramachandra.<newblock>
      <with|font-shape|italic|Lectures on the Mean-value and Omega-theorems
      for the Riemann Zeta-function>.<newblock> Lectures on mathematics and
      physics. Tata Institute of Fundamental Research, 1995.<newblock>

      <bibitem*|7><label|bib-raadstrom1953iteration>Hans Rådström.<newblock>
...
<\references>
  <\collection>
    ...
    <associate|auto-9|<tuple|38|10>>
    <associate|bib-HardyZ|<tuple|2|10>>
    <associate|bib-Johansson2013arb|<tuple|3|10>>
    <associate|bib-milnor2006dynamics|<tuple|4|10>>
    <associate|bib-raadstrom1953iteration|<tuple|7|10>>
    <associate|bib-ramachandra1995lectures|<tuple|6|10>>
...
<\auxiliary>
  <\collection>
    ...
    <\associate|figure>
      <tuple|normal|The functions <with|mode|<quote|math>|\<vartheta\><around*|(|y<rsub|n>|)>+S<around*|(|y<rsub|n>|)>-<around*|(|n-<frac|3|2>|)>\<pi\>>
      ...
      <tuple|normal|<with|mode|<quote|math>|The> functions which are
      subtracted or added to <with|mode|<quote|math>|t> to get
      <with|mode|<quote|math>|Y<rsub|1><around*|(|t|)>,Y<rsub|2><around*|(|t|)>,Y<rsub|3><around*|(|t|)>,Y<rsub|4><around*|(|t|)>>.
      ...
      <tuple|normal|Multipler<with|mode|<quote|math>|> of the maps
      <with|mode|<quote|math>|Y<rsub|1><around*|(|t|)>> and
    ...
    <\associate|toc>
      ...
      <with|par-left|<quote|1tab>|1.2<space|2spc>Transcendental Equations
